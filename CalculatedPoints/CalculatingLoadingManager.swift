...
///
/// The updateProgress function is used to update the progress property. It takes a Float value as a parameter, which represents the progress value. When called, the function sends the value using the progressSubject. The PassthroughSubject forwards the value to the progress property, which is updated.
class CalculatingLoadingManager: ObservableObject {
    ...
    // Define a @Published property called progress of type Float, which is initialized to 0.0
    // When this property is updated, SwiftUI will automatically update the UI
    @Published var progress: Float = 0.0

    @Published var nameLoading: String = ""

    // Create a PassthroughSubject instance of type Float and Never, which can be used to send progress values
    ...
    // Define a function called updateProgress that takes a Float value as a parameter
